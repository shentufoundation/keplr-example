...
export var SignatureDescriptors = {
    ...
    fromJSON: function (object) {
        return {
            signatures: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.signatures)
                ? object.signatures.map(function (e) { return SignatureDescriptor.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.signatures) === null || _a === void 0 ? void 0 : _a.length) {
            obj.signatures = message.signatures.map(function (e) { return SignatureDescriptor.toJSON(e); });
        }
        return obj;
    },
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseSignatureDescriptors();
        message.signatures = ((_a = object.signatures) === null || _a === void 0 ? void 0 : _a.map(function (e) { return SignatureDescriptor.fromPartial(e); })) || [];
        return message;
    },
};
...
export var SignatureDescriptor_Data_Multi = {
    ...
    fromJSON: function (object) {
        return {
            ...
            signatures: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.signatures)
                ? object.signatures.map(function (e) { return SignatureDescriptor_Data.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.signatures) === null || _a === void 0 ? void 0 : _a.length) {
            obj.signatures = message.signatures.map(function (e) { return SignatureDescriptor_Data.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.bitarray = (object.bitarray !== undefined && object.bitarray !== null)
            ...
            : undefined;
        message.signatures = ((_a = object.signatures) === null || _a === void 0 ? void 0 : _a.map(function (e) { return SignatureDescriptor_Data.fromPartial(e); })) || [];
        return message;
    },
};
