...
export var TxResponse = {
    ...
    fromJSON: function (object) {
        return {
            ...
            logs: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.logs) ? object.logs.map(function (e) { return ABCIMessageLog.fromJSON(e); }) : [],
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.logs) === null || _a === void 0 ? void 0 : _a.length) {
            obj.logs = message.logs.map(function (e) { return ABCIMessageLog.toJSON(e); });
        }
        if (message.info !== "") {
    ...
    fromPartial: function (object) {
        ...
        message.logs = ((_g = object.logs) === null || _g === void 0 ? void 0 : _g.map(function (e) { return ABCIMessageLog.fromPartial(e); })) || [];
        ...
        message.events = ((_m = object.events) === null || _m === void 0 ? void 0 : _m.map(function (e) { return Event.fromPartial(e); })) || [];
        return message;
    },
};
...
export var ABCIMessageLog = {
    ...
    fromJSON: function (object) {
        return {
            ...
            events: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.events) ? object.events.map(function (e) { return StringEvent.fromJSON(e); }) : [],
        };
    },
    toJSON: function (message) {
        var _a;
        ...
        if ((_a = message.events) === null || _a === void 0 ? void 0 : _a.length) {
            obj.events = message.events.map(function (e) { return StringEvent.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.events = ((_c = object.events) === null || _c === void 0 ? void 0 : _c.map(function (e) { return StringEvent.fromPartial(e); })) || [];
        return message;
    },
};
...
export var StringEvent = {
    ...
    fromJSON: function (object) {
        return {
            ...
            attributes: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.attributes)
                ? object.attributes.map(function (e) { return Attribute.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.attributes) === null || _a === void 0 ? void 0 : _a.length) {
            obj.attributes = message.attributes.map(function (e) { return Attribute.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.attributes = ((_b = object.attributes) === null || _b === void 0 ? void 0 : _b.map(function (e) { return Attribute.fromPartial(e); })) || [];
        return message;
    },
};
...
export var Result = {
    ...
    fromJSON: function (object) {
        return {
            ...
            log: isSet(object.log) ? globalThis.String(object.log) : "",
            events: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.events) ? object.events.map(function (e) { return Event.fromJSON(e); }) : [],
            msgResponses: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.msgResponses)
                ? object.msgResponses.map(function (e) { return Any.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_b = message.msgResponses) === null || _b === void 0 ? void 0 : _b.length) {
            obj.msgResponses = message.msgResponses.map(function (e) { return Any.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.log = (_b = object.log) !== null && _b !== void 0 ? _b : "";
        message.events = ((_c = object.events) === null || _c === void 0 ? void 0 : _c.map(function (e) { return Event.fromPartial(e); })) || [];
        message.msgResponses = ((_d = object.msgResponses) === null || _d === void 0 ? void 0 : _d.map(function (e) { return Any.fromPartial(e); })) || [];
        return message;
    },
};
...
export var TxMsgData = {
    ...
    fromJSON: function (object) {
        return {
            data: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.data) ? object.data.map(function (e) { return MsgData.fromJSON(e); }) : [],
            msgResponses: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.msgResponses)
                ? object.msgResponses.map(function (e) { return Any.fromJSON(e); })
                : [],
        };
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.data) === null || _a === void 0 ? void 0 : _a.length) {
            obj.data = message.data.map(function (e) { return MsgData.toJSON(e); });
        }
        if ((_b = message.msgResponses) === null || _b === void 0 ? void 0 : _b.length) {
            obj.msgResponses = message.msgResponses.map(function (e) { return Any.toJSON(e); });
        }
    ...
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseTxMsgData();
        message.data = ((_a = object.data) === null || _a === void 0 ? void 0 : _a.map(function (e) { return MsgData.fromPartial(e); })) || [];
        message.msgResponses = ((_b = object.msgResponses) === null || _b === void 0 ? void 0 : _b.map(function (e) { return Any.fromPartial(e); })) || [];
        return message;
    },
};
...
export var SearchTxsResult = {
    ...
    fromJSON: function (object) {
        return {
            ...
            txs: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.txs) ? object.txs.map(function (e) { return TxResponse.fromJSON(e); }) : [],
        };
    },
    toJSON: function (message) {
        var _a;
        ...
        if ((_a = message.txs) === null || _a === void 0 ? void 0 : _a.length) {
            obj.txs = message.txs.map(function (e) { return TxResponse.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.txs = ((_f = object.txs) === null || _f === void 0 ? void 0 : _f.map(function (e) { return TxResponse.fromPartial(e); })) || [];
        return message;
    },
};
