...
export declare const MsgUpdateParams: {
    ...
    } & { [K_5 in Exclude<keyof I, keyof MsgUpdateParams>]: never; }>(base?: I): MsgUpdateParams;
    fromPartial<I_1 extends {
        authority?: string;
        params?: {
            minDeposit?: {
        ...
        params?: {
            ...
            minDeposit?: {
                ...
                denom?: string;
                amount?: string;
            } & { [K_6 in Exclude<keyof I_1["params"]["minDeposit"][number], keyof Coin>]: never; })[] & { [K_7 in Exclude<keyof I_1["params"]["minDeposit"], keyof {
                denom?: string;
                amount?: string;
            }[]>]: never; };
            maxDepositPeriod?: {
                ...
                seconds?: string;
                nanos?: number;
            } & { [K_8 in Exclude<keyof I_1["params"]["maxDepositPeriod"], keyof import("../../../google/protobuf/duration").Duration>]: never; };
            votingPeriod?: {
                seconds?: string;
                nanos?: number;
            } & {
                seconds?: string;
                nanos?: number;
            } & { [K_9 in Exclude<keyof I_1["params"]["votingPeriod"], keyof import("../../../google/protobuf/duration").Duration>]: never; };
            quorum?: string;
            threshold?: string;
            vetoThreshold?: string;
            minInitialDepositRatio?: string;
    ...
    } & { [K_11 in Exclude<keyof I_1, keyof MsgUpdateParams>]: never; }>(object: I_1): MsgUpdateParams;
};
