...
export var Proposal = {
    ...
    fromJSON: function (object) {
        return {
            ...
            totalDeposit: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.totalDeposit)
                ? object.totalDeposit.map(function (e) { return Coin.fromJSON(e); })
                : [],
    ...
    toJSON: function (message) {
        ...
        if ((_b = message.totalDeposit) === null || _b === void 0 ? void 0 : _b.length) {
            obj.totalDeposit = message.totalDeposit.map(function (e) { return Coin.toJSON(e); });
        }
        if (message.votingStartTime !== undefined) {
    ...
    fromPartial: function (object) {
        ...
        message.messages = ((_b = object.messages) === null || _b === void 0 ? void 0 : _b.map(function (e) { return Any.fromPartial(e); })) || [];
        ...
        message.totalDeposit = ((_f = object.totalDeposit) === null || _f === void 0 ? void 0 : _f.map(function (e) { return Coin.fromPartial(e); })) || [];
...
export var DepositParams = {
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseDepositParams();
        message.minDeposit = ((_a = object.minDeposit) === null || _a === void 0 ? void 0 : _a.map(function (e) { return Coin.fromPartial(e); })) || [];
