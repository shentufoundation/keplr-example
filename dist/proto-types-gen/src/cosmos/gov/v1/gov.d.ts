...
export declare const Params: {
    ...
    create<I extends {
        ...
        burnProposalDepositPrevote?: boolean;
        burnVoteVeto?: boolean;
    } & { [K_4 in Exclude<keyof I, keyof Params>]: never; }>(base?: I): Params;
    fromPartial<I_1 extends {
        minDeposit?: {
            denom?: string;
            amount?: string;
        ...
        maxDepositPeriod?: {
            ...
            seconds?: string;
            nanos?: number;
        } & { [K_7 in Exclude<keyof I_1["maxDepositPeriod"], keyof Duration>]: never; };
        votingPeriod?: {
            seconds?: string;
            nanos?: number;
        } & {
            seconds?: string;
            nanos?: number;
        } & { [K_8 in Exclude<keyof I_1["votingPeriod"], keyof Duration>]: never; };
        quorum?: string;
        threshold?: string;
        vetoThreshold?: string;
        minInitialDepositRatio?: string;
