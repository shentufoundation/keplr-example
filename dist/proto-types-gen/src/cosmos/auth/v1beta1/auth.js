    ...
    fromJSON: function (object) {
        return {
            ...
            permissions: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.permissions)
                ? object.permissions.map(function (e) { return globalThis.String(e); })
                : [],
        };
    },
    toJSON: function (message) {
...
export var ModuleCredential = {
    ...
    fromJSON: function (object) {
        return {
            ...
            derivationKeys: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.derivationKeys)
                ? object.derivationKeys.map(function (e) { return bytesFromBase64(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.derivationKeys) === null || _a === void 0 ? void 0 : _a.length) {
            obj.derivationKeys = message.derivationKeys.map(function (e) { return base64FromBytes(e); });
        }
        return obj;
    },
    create: function (base) {
