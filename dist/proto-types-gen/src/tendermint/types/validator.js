...
export var ValidatorSet = {
    ...
    fromJSON: function (object) {
        return {
            validators: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.validators)
                ? object.validators.map(function (e) { return Validator.fromJSON(e); })
                : [],
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.validators) === null || _a === void 0 ? void 0 : _a.length) {
            obj.validators = message.validators.map(function (e) { return Validator.toJSON(e); });
        }
        if (message.proposer !== undefined) {
    ...
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseValidatorSet();
        message.validators = ((_a = object.validators) === null || _a === void 0 ? void 0 : _a.map(function (e) { return Validator.fromPartial(e); })) || [];
