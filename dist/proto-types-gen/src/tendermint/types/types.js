...
export var Data = {
    ...
    fromJSON: function (object) {
        return { txs: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.txs) ? object.txs.map(function (e) { return bytesFromBase64(e); }) : [] };
    },
    toJSON: function (message) {
        var _a;
        var obj = {};
        if ((_a = message.txs) === null || _a === void 0 ? void 0 : _a.length) {
            obj.txs = message.txs.map(function (e) { return base64FromBytes(e); });
        }
        return obj;
    },
    create: function (base) {
...
export var Commit = {
    ...
    fromJSON: function (object) {
        return {
            ...
            signatures: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.signatures)
                ? object.signatures.map(function (e) { return CommitSig.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.signatures) === null || _a === void 0 ? void 0 : _a.length) {
            obj.signatures = message.signatures.map(function (e) { return CommitSig.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.blockId = (object.blockId !== undefined && object.blockId !== null)
            ? BlockID.fromPartial(object.blockId)
            : undefined;
        message.signatures = ((_c = object.signatures) === null || _c === void 0 ? void 0 : _c.map(function (e) { return CommitSig.fromPartial(e); })) || [];
        return message;
    },
};
