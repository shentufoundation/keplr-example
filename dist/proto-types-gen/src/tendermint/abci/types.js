...
export var RequestInitChain = {
    ...
    fromJSON: function (object) {
        return {
            ...
            validators: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.validators)
                ? object.validators.map(function (e) { return ValidatorUpdate.fromJSON(e); })
                : [],
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.validators) === null || _a === void 0 ? void 0 : _a.length) {
            obj.validators = message.validators.map(function (e) { return ValidatorUpdate.toJSON(e); });
        }
        if (message.appStateBytes.length !== 0) {
    ...
    fromPartial: function (object) {
        ...
        message.consensusParams = (object.consensusParams !== undefined && object.consensusParams !== null)
            ...
            : undefined;
        message.validators = ((_c = object.validators) === null || _c === void 0 ? void 0 : _c.map(function (e) { return ValidatorUpdate.fromPartial(e); })) || [];
...
export var RequestBeginBlock = {
    ...
    fromJSON: function (object) {
        return {
            ...
            byzantineValidators: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.byzantineValidators)
                ? object.byzantineValidators.map(function (e) { return Evidence.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.byzantineValidators) === null || _a === void 0 ? void 0 : _a.length) {
            obj.byzantineValidators = message.byzantineValidators.map(function (e) { return Evidence.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.lastCommitInfo = (object.lastCommitInfo !== undefined && object.lastCommitInfo !== null)
            ...
            : undefined;
        message.byzantineValidators = ((_b = object.byzantineValidators) === null || _b === void 0 ? void 0 : _b.map(function (e) { return Evidence.fromPartial(e); })) || [];
        return message;
    },
};
...
export var ResponseInitChain = {
    ...
    fromPartial: function (object) {
        ...
        message.consensusParams = (object.consensusParams !== undefined && object.consensusParams !== null)
            ? ConsensusParams.fromPartial(object.consensusParams)
            : undefined;
        message.validators = ((_a = object.validators) === null || _a === void 0 ? void 0 : _a.map(function (e) { return ValidatorUpdate.fromPartial(e); })) || [];
...
export var ResponseBeginBlock = {
    ...
    fromJSON: function (object) {
        return { events: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.events) ? object.events.map(function (e) { return Event.fromJSON(e); }) : [] };
    },
    toJSON: function (message) {
        var _a;
        var obj = {};
        if ((_a = message.events) === null || _a === void 0 ? void 0 : _a.length) {
            obj.events = message.events.map(function (e) { return Event.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseResponseBeginBlock();
        message.events = ((_a = object.events) === null || _a === void 0 ? void 0 : _a.map(function (e) { return Event.fromPartial(e); })) || [];
        return message;
    },
};
...
export var ResponseCheckTx = {
    ...
    fromJSON: function (object) {
        return {
            ...
            events: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.events) ? object.events.map(function (e) { return Event.fromJSON(e); }) : [],
            codespace: isSet(object.codespace) ? globalThis.String(object.codespace) : "",
        };
    },
    toJSON: function (message) {
    ...
    fromPartial: function (object) {
        ...
        message.events = ((_g = object.events) === null || _g === void 0 ? void 0 : _g.map(function (e) { return Event.fromPartial(e); })) || [];
        message.codespace = (_h = object.codespace) !== null && _h !== void 0 ? _h : "";
        return message;
    },
};
...
export var ResponseEndBlock = {
    ...
    fromJSON: function (object) {
        return {
            validatorUpdates: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.validatorUpdates)
                ? object.validatorUpdates.map(function (e) { return ValidatorUpdate.fromJSON(e); })
                : [],
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.validatorUpdates) === null || _a === void 0 ? void 0 : _a.length) {
            obj.validatorUpdates = message.validatorUpdates.map(function (e) { return ValidatorUpdate.toJSON(e); });
        }
        if (message.consensusParamUpdates !== undefined) {
    ...
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseResponseEndBlock();
        message.validatorUpdates = ((_a = object.validatorUpdates) === null || _a === void 0 ? void 0 : _a.map(function (e) { return ValidatorUpdate.fromPartial(e); })) || [];
        message.consensusParamUpdates =
            (object.consensusParamUpdates !== undefined && object.consensusParamUpdates !== null)
                ...
                : undefined;
        message.events = ((_b = object.events) === null || _b === void 0 ? void 0 : _b.map(function (e) { return Event.fromPartial(e); })) || [];
        return message;
    },
};
...
export var ResponseListSnapshots = {
    ...
    fromJSON: function (object) {
        return {
            snapshots: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.snapshots)
                ? object.snapshots.map(function (e) { return Snapshot.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.snapshots) === null || _a === void 0 ? void 0 : _a.length) {
            obj.snapshots = message.snapshots.map(function (e) { return Snapshot.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseResponseListSnapshots();
        message.snapshots = ((_a = object.snapshots) === null || _a === void 0 ? void 0 : _a.map(function (e) { return Snapshot.fromPartial(e); })) || [];
        return message;
    },
};
    ...
    fromJSON: function (object) {
        return {
            ...
            refetchChunks: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.refetchChunks)
                ? object.refetchChunks.map(function (e) { return globalThis.Number(e); })
                : [],
            rejectSenders: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.rejectSenders)
                ? object.rejectSenders.map(function (e) { return globalThis.String(e); })
                : [],
        };
    },
    toJSON: function (message) {
...
export var LastCommitInfo = {
    ...
    fromJSON: function (object) {
        return {
            ...
            votes: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.votes) ? object.votes.map(function (e) { return VoteInfo.fromJSON(e); }) : [],
        };
    },
    toJSON: function (message) {
        var _a;
        ...
        if ((_a = message.votes) === null || _a === void 0 ? void 0 : _a.length) {
            obj.votes = message.votes.map(function (e) { return VoteInfo.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.votes = ((_b = object.votes) === null || _b === void 0 ? void 0 : _b.map(function (e) { return VoteInfo.fromPartial(e); })) || [];
        return message;
    },
};
...
export var Event = {
    ...
    fromJSON: function (object) {
        return {
            ...
            attributes: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.attributes)
                ? object.attributes.map(function (e) { return EventAttribute.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.attributes) === null || _a === void 0 ? void 0 : _a.length) {
            obj.attributes = message.attributes.map(function (e) { return EventAttribute.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.attributes = ((_b = object.attributes) === null || _b === void 0 ? void 0 : _b.map(function (e) { return EventAttribute.fromPartial(e); })) || [];
        return message;
    },
};
