...
export var simulateMsgs = function (chainInfo, sender, proto, fee, memo) {
    if (memo === void 0) { memo = ""; }
    return __awaiter(void 0, void 0, void 0, function () {
        var account, unsignedTx, simulatedResult, gasUsed;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, api("".concat(OsmosisChainInfo.rest, "/cosmos/tx/v1beta1/simulate"), {
                            method: "POST",
                            headers: {
                ...
                case 2:
                    simulatedResult = _a.sent();
                    gasUsed = parseInt(simulatedResult.gas_info.gas_used);
                    if (Number.isNaN(gasUsed)) {
                        throw new Error("Invalid integer gas: ".concat(simulatedResult.gas_info.gas_used));
                    }
                    return [2 /*return*/, gasUsed];
